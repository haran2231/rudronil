...
const blogs = [
  ...
  },
  {
    ...
    Description: "A car loan is a secured loan used to purchase a new or used vehicle, where the car itself serves as collateral. Loan amounts typically cover 80% to 100% of the car’s on-road price, depending on the lender’s policies. Interest rates range from 7% to 15%, with repayment terms of 3 to 7 years. A good credit score improves loan eligibility and ensures lower interest rates. Comparing different lenders, negotiating interest rates, and choosing a shorter tenure "
  },
];
